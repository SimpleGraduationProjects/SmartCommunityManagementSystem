<template>
	<div class="addEdit-block" :style='{"padding":"30px 0 0"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' class="select" v-if="type!='info'"  label="服务态度" prop="fuwutaidu">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' v-else class="input" label="服务态度" prop="fuwutaidu">
					<el-input v-model="ruleForm.fuwutaidu"
						placeholder="服务态度" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' class="select" v-if="type!='info'"  label="维修水平" prop="weixiushuiping">
					<el-select :disabled="ro.weixiushuiping" v-model="ruleForm.weixiushuiping" placeholder="请选择维修水平" >
						<el-option
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' v-else class="input" label="维修水平" prop="weixiushuiping">
					<el-input v-model="ruleForm.weixiushuiping"
						placeholder="维修水平" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' class="input" v-if="type!='info'"  label="整体评价" prop="zhengtipingjia">
					<el-input v-model="ruleForm.zhengtipingjia" placeholder="整体评价" clearable  :readonly="ro.zhengtipingjia"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' v-else class="input" label="整体评价" prop="zhengtipingjia">
					<el-input v-model="ruleForm.zhengtipingjia" placeholder="整体评价" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' class="date" v-if="type!='info'" label="评价日期" prop="pingjiariqi">
					<el-date-picker
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' class="input" v-else-if="ruleForm.pingjiariqi" label="评价日期" prop="pingjiariqi">
