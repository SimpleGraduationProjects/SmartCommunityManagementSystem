<template>
	<div class="addEdit-block" :style='{"padding":"30px 0 0"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' class="input" v-if="type!='info'" label="预约单号" prop="yuyuedanhao">
					<el-input v-model="ruleForm.yuyuedanhao" placeholder="预约单号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' class="input" v-else-if="ruleForm.yuyuedanhao" label="预约单号" prop="yuyuedanhao">
					<el-input v-model="ruleForm.yuyuedanhao" placeholder="预约单号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' class="input" v-if="type!='info'"  label="电桩分类" prop="dianzhuangfenlei">
					<el-input v-model="ruleForm.dianzhuangfenlei" placeholder="电桩分类" clearable  :readonly="ro.dianzhuangfenlei"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' v-else class="input" label="电桩分类" prop="dianzhuangfenlei">
					<el-input v-model="ruleForm.dianzhuangfenlei" placeholder="电桩分类" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' class="input" v-if="type!='info'"  label="预约备注" prop="yuyuebeizhu">
					<el-input v-model="ruleForm.yuyuebeizhu" placeholder="预约备注" clearable  :readonly="ro.yuyuebeizhu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' v-else class="input" label="预约备注" prop="yuyuebeizhu">
...
export default {
    ...
    info(id) {
      this.$http({
        url: `chongdianzhuangyuyue/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `chongdianzhuangyuyue/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.chongdianzhuangyuyueCrossAddOrUpdateFlag = false;
						 this.parent.search();
