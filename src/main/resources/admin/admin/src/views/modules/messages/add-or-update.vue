	...
	<div class="addEdit-block" :style='{"padding":"30px 0 0"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' class="upload" v-if="type!='info' && !ro.cpicture" label="留言图片" prop="cpicture">
					<file-upload
						tip="点击上传留言图片"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' class="upload" v-else-if="ruleForm.cpicture" label="留言图片" prop="cpicture">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' class="upload" v-if="type!='info' && !ro.rpicture" label="回复图片" prop="rpicture">
					<file-upload
						tip="点击上传回复图片"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' class="upload" v-else-if="ruleForm.rpicture" label="回复图片" prop="rpicture">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' class="textarea" v-if="type!='info'" label="留言内容" prop="content">
					<el-input
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' v-else-if="ruleForm.content" label="留言内容" prop="content">
