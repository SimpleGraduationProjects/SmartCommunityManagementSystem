...
<div :style='{"border":"2px solid #a4d9b7","padding":"20px","margin":"20px auto 0","borderRadius":"8px","flexWrap":"wrap","background":"#fff","width":"1200px","position":"relative"}'>
    <el-form
      ...
      label-width="200px"
    >
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="户主姓名" prop="huzhuxingming">
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}'  label="小区名称" prop="xiaoqumingcheng">
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="单元" prop="danyuan">
            <el-input v-model="ruleForm.danyuan" 
                placeholder="单元" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="户型" prop="huxing">
            <el-input v-model="ruleForm.huxing" 
                placeholder="户型" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="面积" prop="mianji">
            <el-input v-model="ruleForm.mianji" 
                placeholder="面积" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="家庭成员" prop="jiatingchengyuan">
            <el-input v-model="ruleForm.jiatingchengyuan" 
                placeholder="家庭成员" clearable ></el-input>
          </el-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      init(type) {
        ...
        this.$http.get('option/xiaoqu/xiaoqumingcheng', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
