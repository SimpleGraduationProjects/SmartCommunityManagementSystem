...
<div :style='{"border":"2px solid #a4d9b7","padding":"20px","margin":"20px auto 0","borderRadius":"8px","flexWrap":"wrap","background":"#fff","width":"1200px","position":"relative"}'>
    ...
    >
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="户数" prop="hushu">
            <el-input v-model="ruleForm.hushu" 
                placeholder="户数" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="居住人口" prop="juzhurenkou">
            <el-input v-model="ruleForm.juzhurenkou" 
                placeholder="居住人口" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="具体位置" prop="jutiweizhi">
            <el-input v-model="ruleForm.jutiweizhi" 
                placeholder="具体位置" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="小区介绍" prop="xiaoqujieshao">
            <editor 
